...
static void nvme_slm_copy_source_range_parse_format2(void *ranges,
                                                         int idx,
                                                         uint32_t *snsid,
                                                         uint64_t *slba,
                                                         uint32_t *nlb)
{
    NvmeCopySourceRangeFormat2 *_ranges = ranges;
...
static void nvme_slm_copy_source_range_parse_format3(void *ranges,
                                                           int idx,
                                                           uint32_t *snsid,
                                                           uint64_t *slba,
                                                           uint32_t *nlb)
{
    NvmeCopySourceRangeFormat3 *_ranges = ranges;
...
static void nvme_slm_copy_source_range_parse_format4(void *ranges,
                                                           int idx,
                                                           uint32_t *snsid,
                                                           uint64_t *slba,
                                                           uint32_t *nlb)
...
static void nvme_slm_copy_source_range_parse(void *ranges,
                                             ...
                                             uint32_t *nlb)
{
    ...
    case NVME_COPY_FORMAT_2:
        nvme_slm_copy_source_range_parse_format2(ranges, idx, snsid, slba,
                                                     nlb);
        break;
    case NVME_COPY_FORMAT_3:
        nvme_slm_copy_source_range_parse_format3(ranges, idx, snsid,
                                                       slba, nlb);
        break;
...
static void nvme_slm_do_copy(NvmeSLMCopyAIOCB *iocb)
{
    ...
    nvme_slm_copy_source_range_parse(iocb->ranges, iocb->idx, iocb->format,
                                     &snsid, &slba, &nlb);
...
static uint16_t nvme_slm_copy(NvmeCtrl *n, NvmeRequest *req)
{
    ...
    case NVME_COPY_FORMAT_3:
        ...
        if (NVME_COPY_FORMAT_2 == desc_format) {
            len = sizeof(NvmeCopySourceRangeFormat2);
        } else if (NVME_COPY_FORMAT_3 == desc_format) {
            len = sizeof(NvmeCopySourceRangeFormat3);
        }
...
static uint16_t nvme_io_cmd(NvmeCtrl *n, NvmeRequest *req)
{
    ...
    if (req->ns->csi == NVME_CSI_COMPUTE) {
        switch (req->cmd.opcode) {
                                 ...
                                 uint64_t off, NvmeRequest *req)
{
    ...
    case NVME_CC_CSS_CSI:
        ...
        case NVME_CSI_COMPUTE:
            src_iocs = nvme_cse_iocs_compute;
            break;
        }
    }
